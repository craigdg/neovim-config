let g:colors_name = "kingpin"

hi Normal ctermfg=7 ctermbg=0 cterm=NONE
hi IncSearch ctermfg=8 ctermbg=15 cterm=NONE
hi WildMenu ctermfg=NONE ctermbg=1 cterm=NONE
hi SignColumn ctermfg=1 ctermbg=1 cterm=NONE
...
hi StatusLineNC ctermfg=7 ctermbg=5 cterm=NONE
...
hi Todo ctermfg=7 ctermbg=0 cterm=NONE
hi LineNr ctermfg=7 ctermbg=NONE cterm=NONE
hi SpecialComment ctermfg=5 ctermbg=NONE cterm=NONE
...
hi StatusLine ctermfg=0 ctermbg=5 cterm=NONE
...
hi SpellRare ctermfg=1 ctermbg=1 cterm=underline
...
hi VisualNOS ctermfg=1 ctermbg=1 cterm=underline
hi DiffDelete ctermfg=NONE ctermbg=1 cterm=NONE
hi ModeMsg ctermfg=1 ctermbg=1 cterm=NONE
hi Define ctermfg=1 ctermbg=NONE cterm=NONE
hi Function ctermfg=2 ctermbg=NONE cterm=NONE
hi FoldColumn ctermfg=1 ctermbg=1 cterm=NONE
hi PreProc ctermfg=5 ctermbg=NONE cterm=NONE
hi Visual ctermfg=1 ctermbg=1 cterm=NONE
hi MoreMsg ctermfg=7 ctermbg=NONE cterm=NONE
hi SpellCap ctermfg=1 ctermbg=1 cterm=underline
hi VertSplit ctermfg=1 ctermbg=0 cterm=NONE
...
hi SpellLocal ctermfg=1 ctermbg=1 cterm=underline
...
hi SpellBad ctermfg=1 ctermbg=1 cterm=underline
...
hi Underlined ctermfg=1 ctermbg=1 cterm=underline
hi DiffAdd ctermfg=NONE ctermbg=1 cterm=NONE
hi cursorim ctermfg=1 ctermbg=1 cterm=NONE
hi typescriptExport ctermfg=5
hi typescriptStatementKeyword ctermfg=5
hi typescriptBraces ctermfg=7
hi typescriptPredefinedType ctermfg=6
hi typescriptTypeReference ctermfg=6
hi typescriptTypeParameter ctermfg=6
hi typescriptOperator ctermfg=5
